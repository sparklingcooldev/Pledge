...
contract TRVLTestToken is ERC20PresetMinterPauser {
  using SafeMath for uint256;

  string private constant NAME = "TRVLTestToken";
  string private constant SYMBOL = "TRVLTestToken";
    ...
    external
  {
    require(
      ...
      "TRVLTestToken: mintBatch inputs do not have same length"
    );
